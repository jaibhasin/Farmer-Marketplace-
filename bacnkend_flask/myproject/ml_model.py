...
def predict_crop(user_input):
    # Load the trained models, scaler, and label encoder from the correct folder
    logreg = pickle.load(open('./myproject/pkl_files/logreg_model.pkl', 'rb'))
    rf = pickle.load(open('./myproject/pkl_files/rf_model.pkl', 'rb'))
    xgb_model = pickle.load(open('./myproject/pkl_files/xgb_model.pkl', 'rb'))
    scaler = pickle.load(open('./myproject/pkl_files/scaler.pkl', 'rb'))
    label_encoder = pickle.load(open('./myproject/pkl_files/label_encoder.pkl', 'rb'))
