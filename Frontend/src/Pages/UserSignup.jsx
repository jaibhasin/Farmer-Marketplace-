...
function User_SignUp_Page() {
  ...
  async function handlesubmit(e) {
    ...
    try {
      const response = await fetch("http://127.0.0.1:5000/user/sign-up/", {
        method: "POST",
        headers: {
      ...
      if (response.ok) {
        // Assuming success response will have a message
        const responseData = await response.json();
        alert(language ? responseData.message : "खाता सफलतापूर्वक बनाया गया");
      } else {
      ...
      alert(language ? "An error occurred" : "कुछ गलत हो गया");
    }
  }
